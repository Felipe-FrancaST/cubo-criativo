...
async function notifyStatus({order,nextStatus,shipping_tracking,production_eta}){
  ...
  if(nextStatus==='cancelado') { title='Pedido cancelado'; msg='Seu pedido foi cancelado pela loja. Se houve pagamento, o reembolso será processado conforme a forma de pagamento.'; }
